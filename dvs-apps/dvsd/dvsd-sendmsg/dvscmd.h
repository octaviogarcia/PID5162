...
#define MSGHDR_FORMAT "msg_namelen=%d msg_iovlen=%d msg_controllen=%d msg_flags=%X \n" 
#define MSGHDR_FIELDS(p) p->msg_namelen, p->msg_iovlen, p->msg_controllen , p->msg_flags

#define MSGAUX_FORMAT "cmsg_len=%d cmsg_level=%d cmsg_type=%d\n" 
#define MSGAUX_FIELDS(p) p->cmsg_len, p->cmsg_level, p->cmsg_type
